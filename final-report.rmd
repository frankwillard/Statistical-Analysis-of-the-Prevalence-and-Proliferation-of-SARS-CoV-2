...
Our test statistic was 10.221, which has a chi-square distribution with 12 degree of freedom under $H_0$. This correlates with a P-value approximately equal to 0.5966 which is greater than $\alpha$ = 0.05, such that we fail to reject the null hypothesis. There is not sufficient evidence to suggest that human development index category and deaths per case are not independent.
