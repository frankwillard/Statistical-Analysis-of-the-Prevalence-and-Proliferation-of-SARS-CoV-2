...
```{r Installing Packes and Loading Libraries}
...
```{r Adjusting Date and Boxplot Visualization}
...
``` {r COVID-19 Stringency}

# Prints out the stringency indices of each country from highest to lowest
...
#cols = c('male_smokers', 'diabetes_prevalence', 'hospital_beds_per_thousand',  'aged_70_older', 'population_density','aged_65_older', 'population','female_smokers', 'extreme_poverty','stringency_index', 'human_development_index', 'gdp_per_capita', 'life_expectancy', 'handwashing_facilities', 'median_age')
