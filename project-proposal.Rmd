...
#   filter_all(all_vars(!is.na(.)))
# 
# x_var <- model.matrix(deaths_per_case~. , covid_final_date_deaths)[,-1]
# y_var <- covid_final_date_deaths$deaths_per_case
# 
# lambdas <- 10^seq(2, -3, by = -.1)
# 
# set.seed(86)
# train = sample(1:nrow(x_vars), 0.7 * nrow(x_vars))
# x_test = (-train)
# y_test = y_var[x_test]
# 
...
# lasso_best <- glmnet(x_vars[train,], y_var[train], alpha = 1, lambda = 10)
...
# 
# pred <- predict(lasso_best, s = best_lam, newx = x_vars[x_test,])
# eval_results(y_test, pred, x_test)
