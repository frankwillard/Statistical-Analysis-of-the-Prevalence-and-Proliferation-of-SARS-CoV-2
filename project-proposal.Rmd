...
covid_continent_str_i <- covid_final %>%
  group_by(continent) %>%
  filter(!is.na(stringency_index)) %>%
...
In looking at the summary statistics for the dataset, it becomes clear our perception of global stringency indexes by continent was off, as South America had the highest mean stringency index and Africa had the 3rd highest. Thus, the average stringency index of Africa and South America was 63.46324, much greater than the mere 54.22835 of Europe, Asia, Oceania, and North America.
